...
public class CampChallenge extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        out.println("<input type = submit name = \"btn\" value = \"追加\">");
        out.println("</form>");
        ...
        try {
            ...
            sql = "INSERT INTO profiles VALUES(" + Integer.parseInt(id) + ",'" + name + "','" + tell + "'," + Integer.parseInt(age) + ",'" + birthday + "')";
